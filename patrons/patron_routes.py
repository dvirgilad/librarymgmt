...
from patrons.dal.patron_model import PatronReturn, PatronEdit, PatronCreate
...
async def get_patron_route(patron_id: str) -> PatronReturn:
    ...
    :rtype: Patron
    """
    return await get_patron(patron_id)


@PATRON_ROUTER.get("/")
async def get_all_patrons_route(
    limit: Annotated[
    ...
    return await get_all_patrons(limit, skip)


@PATRON_ROUTER.post("/", response_model=str)
async def post_patron_route(patron: PatronCreate) -> str:
    ...
    :rtype: str
    """
    return await create_patron(patron)


@PATRON_ROUTER.delete("/{patron_id}")
async def delete_patron_route(patron_id: str) -> None:
    ...
    """
    await remove_patron(patron_id)


@PATRON_ROUTER.patch("/{patron_id}")
async def update_patron_route(patron_id: str, updated_patron: PatronEdit) -> None:
    ...
    """
    await update_patron(patron_id, updated_patron)
